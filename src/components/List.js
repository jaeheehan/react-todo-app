...
const List = React.memo(({
                             myKey, id, title, completed, todoData, setTodoData, provided, snapshot}) => {
    ...
    if(isEditing){
        ...
        return (
            <div key={myKey} {...provided.draggableProps} ref={provided.innerRef} {...provided.dragHandleProps}
            ...
            >
                <div className="items-center">
                    <input type="checkbox" defaultChecked={completed}
                           onChange={() => handleChangeComplete(id)}/> &nbsp;
